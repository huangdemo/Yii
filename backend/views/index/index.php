    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                  ...
                  <!--   <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                    ...
                    <li>
                        <a class="J_menuItem" href="<?=Url::to(['index/stats'],true)?>">
                  ...
                  <!--   <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                    ...
                    <li>
                        <a href="mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label">管理人 </span><span class="label label-warning pull-right">16</span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?=Url::to(['admin-user/add'],true)?>">添加用户</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?=Url::to(['admin-user/list'],true)?>">后台用户</a>
                            </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="<?=Url::to(['index/stats'],true)?>" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
