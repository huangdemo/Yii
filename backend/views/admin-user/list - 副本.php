             ...
             getorder:function(){
                 this.$http.post(UrlArgent.CreateUrl('admin-user/list.html'),{
                    ...
                    limit:this.limit,//多少条分页
                     ...
                     this.totalPageCount= Math.ceil(res.body.data.totalNumber/this.limit);//获取总页数
                 })
                 ...
                 //        app.lists=res.data.lists; //获取数据
                 //        app.totalPageCount= Math.ceil(res.data.totalNumber/app.limit);//获取总页数
                 //    }
                 // })
